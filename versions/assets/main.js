...
(()=>{
    ...
    ;
    var Ce = (t,e,r)=>(r = t != null ? Se(ke(t)) : {},
    Ie(e || !t || !t.__esModule ? re(r, "default", {
        value: t,
        enumerable: !0
    }) : r, t));
    var ae = Pe((se,oe)=>{
...
`, e)
            ...
            t.Vector.prototype.dot = function(e) {
                for (var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, l = 0, u = 0, d = 0; u < s && d < o; )
                    a = n[u],
                    l = i[d],
                    a < l ? u += 2 : a > l ? d += 2 : a == l && (r += n[u + 1] * i[d + 1],
                    u += 2,
                    d += 2);
                return r
            }
                ...
                var e = {
                  ...
                  , H = function(c) {
                    ...
                    h.test(c)) {
                        ...
                        O = _,
                        F = B,
                        x.test(c) ? c = c + "e" : O.test(c) ? (h = S,
                        c = c.replace(h, "")) : F.test(c) && (c = c + "e"))
                    }
                    if (h = A,
                    h.test(c)) {
                        var L = h.exec(c);
            ...
            t.TokenSet.fromFuzzyString = function(e, r) {
                for (var n = new t.TokenSet, i = [{
                    ...
                    if (s.editsRemaining != 0) {
                        ...
                        if (s.str.length > 1) {
                            var d = s.str.charAt(0), m = s.str.charAt(1), y;
                            m in s.node.edges ? y = s.node.edges[m] : (y = new t.TokenSet,
                            s.node.edges[m] = y),
                        ...
                        for (var d = s[u], m = 0; m < l; m++) {
                            ...
                            if (y == d || d == "*") {
                                var b = n.node.edges[y]
                                  ...
                                  , E = b.final && g.final
                                  , f = void 0;
                                y in n.output.edges ? (f = n.output.edges[y],
                                f.final = f.final || E) : (f = new t.TokenSet,
                                f.final = E,
                                n.output.edges[y] = f),
                                i.push({
                                    qNode: g,
            ...
            t.Index.prototype.query = function(e) {
                for (var r = new t.Query(this.fields), n = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), l = 0; l < this.fields.length; l++)
                ...
                for (var l = 0; l < r.clauses.length; l++) {
                    var u = r.clauses[l]
                      , d = null
                      , m = t.Set.empty;
                    u.usePipeline ? d = this.pipeline.runString(u.term, {
                        fields: u.fields
                    }) : d = [u.term];
                        ...
                        for (var w = 0; w < E.length; w++)
                            for (var S = E[w], k = this.invertedIndex[S], _ = k._index, f = 0; f < u.fields.length; f++) {
                                var p = u.fields[f]
                                  ...
                                  , j = S + "/" + p
                                  , q = new t.Set(A);
                                if (u.presence == t.Query.presence.REQUIRED && (m = m.union(q),
                                ...
                                !s[j]) {
                                    for (var V = 0; V < A.length; V++) {
                                        var $ = A[V], I = new t.FieldRef($,p), z = B[$], W;
                ...
                for (var l = 0; l < c.length; l++) {
                    ...
                    if (H.contains(h) && !R.contains(h)) {
                        var x = this.fieldVectors[T], O = i[T.fieldName].similarity(x), F;
                        if ((F = C[h]) !== void 0)
                            F.score += O,
                            F.matchData.combine(n[T]);
                        else {
                            var L = {
                                ref: h,
                                score: O,
            ...
            t.Builder.prototype.createFieldVectors = function() {
                for (var e = {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
                    for (var o = t.FieldRef.fromString(r[s]), a = o.fieldName, l = this.fieldLengths[o], u = new t.Vector, d = this.fieldTermFrequencies[o], m = Object.keys(d), y = m.length, b = this._fields[a].boost || 1, g = this._documents[o.docRef].boost || 1, E = 0; E < y; E++) {
                        var f = m[E], p = d[f], w = this.invertedIndex[f]._index, S, k, _;
                        i[f] === void 0 ? (S = t.idf(this.invertedIndex[f], this.documentCount),
                        i[f] = S) : S = i[f],
    ...
    var U = class {
        ...
        createComponents(e) {
            ne.forEach(r=>{
                e.querySelectorAll(r.selector).forEach(n=>{
                    n.dataset.hasInstance || (new r.constructor({
                        el: n,
                        app: this
                    }),
        ...
        ensureActivePageVisible() {
            ...
            for (; r && !r.classList.contains(".tsd-navigation"); )
                r instanceof HTMLDetailsElement && (r.open = !0),
                r = r.parentElement;
            if (e) {
        ...
        ensureFocusedElementVisible() {
            if (this.alwaysVisibleMember && (this.alwaysVisibleMember.classList.remove("always-visible"),
            ...
            for (; r && r.tagName !== "SECTION"; )
                r = r.parentElement;
            if (r && r.offsetParent == null) {
                this.alwaysVisibleMember = r,
                r.classList.add("always-visible");
    ...
    function Oe(t, e, r, n) {
        ...
        r.addEventListener("keydown", s=>{
            i = !0,
            s.key == "Enter" ? Fe(e, r) : s.key == "Escape" ? r.blur() : s.key == "ArrowUp" ? ue(e, -1) : s.key === "ArrowDown" ? ue(e, 1) : i = !1
        }
        ),
        ...
        document.body.addEventListener("keydown", s=>{
            s.altKey || s.ctrlKey || s.metaKey || !r.matches(":focus") && s.key === "/" && (r.focus(),
            s.preventDefault())
        }
        )
    }
    function _e(t, e) {
        t.index || window.searchData && (e.classList.remove("loading"),
    ...
    function ue(t, e) {
        ...
        if (!r)
            ...
            if (e === 1)
                do
                    n = n.nextElementSibling ?? void 0;
                while (n instanceof HTMLElement && n.offsetParent == null);
            else
                do
                    n = n.previousElementSibling ?? void 0;
                while (n instanceof HTMLElement && n.offsetParent == null);
            n && (r.classList.remove("current"),
            n.classList.add("current"))
        }
    }
    function Fe(t, e) {
        let r = t.querySelector(".current");
        if (r || (r = t.querySelector("li:first-child")),
        r) {
    ...
    pe && "ontouchstart"in document.documentElement && (De = !0,
    M = "touchstart",
    fe = "touchmove",
    N = "touchend");
    ...
    var X = class extends P {
        ...
        onDocumentPointerDown(r) {
            if (this.active) {
                if (r.target.closest(".col-sidebar, .tsd-filter-group"))
                    return;
                this.setActive(!1)
            }
        }
